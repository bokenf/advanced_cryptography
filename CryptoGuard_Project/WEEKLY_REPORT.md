...
## 1. Objective
To configure a secure development environment for cryptographic operations, including Python, virtual environments, and Git version control.

## 2. Technical Tasks Completed
- [x] Installed Python and VS Code.
- [x] Configured a Python virtual environment (`venv`).
- [x] Installed the `cryptography` library.
- [x] Validated environment with an encryption/decryption script.
- [x] Initialized a local Git repository and pushed to GitHub.
...
## 5. Reflection
This week allowed me to establish a secure foundation for cryptography development. Using `venv` ensured that my project dependencies remained isolated, preventing conflicts with system-wide Python installations. Mastering basic Git commands provided the necessary audit trail for my code development.